...
import order from '../../images/orders/order2.png'
import id from '../../images/orders/id.png'
import note from '../../images/orders/starusServed.png'
const Order1 = () => {
  return (
    <div>
        <div className='outer' >
            ...
            <div className='orderno'>
                ...
                <span className='detail'>Order 2</span>
            ...
            <div className='idbox'>
              ...
              <img  src={note} alt='note' className='served'/>
            </div>
